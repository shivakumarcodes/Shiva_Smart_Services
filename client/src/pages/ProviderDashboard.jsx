...
const ProviderDashboard = () => {
  ...
  const handleBookingAction = async (bookingId, action) => {
    try {
      ...
      await axios.put(
        `${BASE_URL}/api/provider/bookings/${bookingId}`,
        { action },
        {
          headers: {
      ...
      try {
        ...
        const transformedData = {
          ...
          services: response.data.services.map(service => ({
            ...
            image: service.imageUrl || `${BASE_URL}${service.imageUrl}` || 'https://bluetree.com.au/wp-content/uploads/2016/10/DBlue_Services.png'
          })),
